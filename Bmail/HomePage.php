...
<body>
<div class="container">
<h3 class="header homeheader"><span class="b">B</span>mail</h3>
</div>
<!--NAVIGATION-->
<div class="container">
	<ul class="navigation">
    	<li class="navitem"><a href="ajaxInbox.php" onclick="getInbox()" id="inbox" class="navitem-a">Inbox</a></li>
        <!--<li class="navitem" id="compose">Compose</li>-->
        <li class="navitem"><a href="ajaxCompose.php" onclick="getCompose()" id="compose" class="navitem-a">Compose</a></li>
        <li class="navitem"><a href="ajaxSend.php" onclick="" id="compose" class="navitem-a">Send</a></li>
        <li class="navitem"><a href="ajaxDraft.php" onclick="" id="compose" class="navitem-a">Draft</a></li>
        <li class="navitem"><a href="ajaxTrash.php" onclick="" id="compose" class="navitem-a">Trash</a></li>
    </ul>
</div>
<p>
<div class="container">
