<?php
	...
	$selQQuery = "select * from tbl_adminshedule";
	...
	if($_GET['delId'])
	{
		$delQry="delete from tbl_adminshedule where SchId=".$idNo."";
		//echo $delQry;
		mysql_query($delQry);
  ...
  <tbody>
   <?php
	  	while($row=mysql_fetch_array($QRes))
		{
	  	?>
        <tr>
      <td value="<?php echo $row['SchId'];?>"><?php echo $row['schDate'];?></td>
      <td value="<?php echo $row['SchId'];?>"><?php echo $row['schTime'];?></td>
      <td><a href="Schedules.php?delId=1&amp;id=<?php echo $row['SchId'] ?>"><span class="delete">X</span></a></td>
    </tr>
      <?php
		}
		?>
